...
public class DeviceConnect extends AppCompatActivity {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BleService.ACTION_GATT_CONNECTED.equals(action)) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(DeviceConnect.this, R.string.Device_connection_successful,
                                Toast.LENGTH_LONG).show();
                    }
                });
            }
            if (BleService.ACTION_GATT_DISCONNECTED.equals(action)) {
                Toast.makeText(DeviceConnect.this, R.string.Device_disconnected4, Toast.LENGTH_LONG)
                        .show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.Service_list);
