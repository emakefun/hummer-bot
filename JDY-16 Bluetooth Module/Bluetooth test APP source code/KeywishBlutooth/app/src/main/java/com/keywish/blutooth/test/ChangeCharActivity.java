...
public class ChangeCharActivity extends AppCompatActivity implements OnClickListener {
            ...
            if (BleService.ACTION_CHAR_READED.equals(action)) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        charString.setText(getString(R.string.string2) + stringValue);
                        charHex.setText(getString(R.string.Hexadecimal2) + hexValue);
                        time.setText(getString(R.string.reading_time) + readTime);
            ...
            if (BleService.ACTION_DATA_AVAILABLE.equals(action)) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        resultcount.setText(getString(R.string.byte2) + resultLength);
                    }
                });
            }
            if (BleService.ACTION_GATT_DISCONNECTED.equals(action)) {
                Toast.makeText(ChangeCharActivity.this, R.string.Device_disconnected1,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.Feature_operation);
    ...
    private void init() {
        ...
        clear_result.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                resultLengthNum = 0;
                resultcount.setText(R.string.byte_0);
            }
        });
    ...
    private void saveResualt(String result) {
        // TODO Auto-generated method stub
        if (result.isEmpty()) {
            Toast.makeText(this, "No_content_can_be_saved!", Toast.LENGTH_SHORT).show();
        } else {
            try {
                ...
                Toast.makeText(
                        ...
                        "BLElog" + System.currentTimeMillis()
                                + getString(R.string.txt_save_to_sd), Toast.LENGTH_SHORT)
                        .show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void writeDialog() {
        ...
        timing_write.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (writing) {
                    timing_write.setText(R.string.Send_regularly);
                    writing = false;
                } else {
                    timing_write.setText(R.string.stop_send);
                    write_byte_number = 0;
                    writing = true;
                }
                            ...
                            while (writing) {
                                ...
                                if (!charvalue.isEmpty()) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            // TODO Auto-generated method stub
                                            timing_write_count.setText(getString(R.string.Total3)
                                                    + write_byte_number);
                                        }
                                    });
                                }
        ...
        dialog.setPositiveButton(R.string.send_text, new DialogInterface.OnClickListener() {
            @SuppressLint("NewApi")
            @Override
            ...
            case R.id.btn_notify:
                if (!startNotify) {
                    bleService.mBluetoothGatt.setCharacteristicNotification(
                            gattChar, true);
                    startNotify = true;
                    notifyButton.setText(R.string.stop_Notice);
                } else {
                    bleService.mBluetoothGatt.setCharacteristicNotification(
                            gattChar, false);
                    startNotify = false;
                    notifyButton.setText(R.string.start_Notice);
                }
                break;
        }
    }
